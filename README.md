...
#№ Описание файлов
1) Папка notebook содержит саму тетрадку с выполненным проектом
2) app_skate.py - само приложение
3) df_grouped.csv, scores.csv - содержит используемый датасеты

...
**Ссылка на сайт: [Ссылка на сайт]([https://github.com/ваш-username/ваш-репозиторий](https://projectforskaters-fpuycatpiaykyatfdivzez.streamlit.app))**
...
- **Список элементов**: При клике на элемент отображается его полное описание (тип, уровень сложности и т.д.).
  
Главная страница.
На ней мы видим:
1) Боковую панель "Параметры", которая отвечает за основные действия
   - В ней мы вибираем 
3) Главный экран на котором мы видим:
-  4 строчки нашего датасета
-  Описание функционала
-  Список элементов(при клике на него видим полное описание всех элементов) 
